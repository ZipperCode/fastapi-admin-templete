...
from app.admin.schemas.decorate import DecoratePageSaveIn, DecorateDataArticleIn, DecorateTabbarSaveIn
from app.admin.service.decorate.data_article import IDecorateArticleService, DecorateArticleService
