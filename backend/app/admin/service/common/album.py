...
from app.admin.schemas.common import CommonAlbumListIn, CommonAlbumCateListIn, CommonAlbumCateOut, \
...
from app.models.common import common_album, common_album_cate
